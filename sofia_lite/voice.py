...
async def voice_webhook(request: Request):
    ...
    try:
        ...
        logger.info(f"📞 Voice call from {phone}: {transcript[:50] if transcript else 'No transcript'}...")
...
async def voice_transcribe_webhook(request: Request):
    ...
    try:
        ...
        logger.info(f"🎤 Voice transcription from {phone}: {transcript[:50]}... (confidence: {confidence})")
